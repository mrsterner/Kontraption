...
object KontraptionContainerTypes {
    ...
    val ION_THRUSTER: ContainerTypeRegistryObject<MekanismTileContainer<TileEntityIonThruster>> =
        CONTAINER_TYPES.register(
            KontraptionBlocks.ION_THRUSTER,
            TileEntityIonThruster::class.java,
        )
