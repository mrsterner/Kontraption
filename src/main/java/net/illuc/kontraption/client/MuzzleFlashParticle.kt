...
class MuzzleFlashParticle protected constructor(world: ClientLevel?, posX: Double, posY: Double, posZ: Double, velX: Double, velY: Double, velZ: Double, scale: Double, speed: Double, spriteSet: SpriteSet?) : TextureSheetParticle(
    world,
    posX,
    posY,
    posZ,
    ...
    class Factory(private val spriteSet: SpriteSet?) : ParticleProvider<MuzzleFlashParticleData> {
        override fun createParticle(
            muzzleFlashParticleData: MuzzleFlashParticleData,
            world: ClientLevel,
            x: Double,
            y: Double,
            z: Double,
